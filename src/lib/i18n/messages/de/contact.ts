...
export const contact: ContactMessages = {
	...
	'contact.section.notes': 'Notizen',
	'contact.section.photos': 'Fotos',
	...
	'contact.relationships.reviewAgain': 'Erneut prüfen',
	'contact.relationships.reviewHeading': 'Vorschläge',
	'contact.relationships.reviewOpenCount': (p) => `${p.count} offen`,
	'contact.relationships.reviewNothing': (p) =>
		`Nichts Offenes. Stella findet um ${p.name} nichts, was nicht schon eingetragen ist.`,
	'contact.relationships.confidence.certain': 'sicher',
	'contact.relationships.confidence.likely': 'wahrscheinlich',
	'contact.relationships.confidence.possible': 'möglich',
	'contact.relationships.declinedCount': (p) =>
		p.count === 1 ? '1 abgelehnter Vorschlag' : `${p.count} abgelehnte Vorschläge`,
	'contact.relationships.declinedOn': (p) => `abgelehnt am ${p.day}`,
