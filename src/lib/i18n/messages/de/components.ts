...
export const components: ComponentsMessages = {
	...
	'components.personSearch.createBack': 'Zurück zur Suche',
	'components.personSearch.firstName': 'Vorname',
	'components.personSearch.lastName': 'Nachname',
	'components.personSearch.nickname': 'Spitzname',
	'components.personSearch.birthDate': 'Geburtstag',
	'components.personSearch.more': 'Weitere Angaben',
	'components.personSearch.visibility': 'Wer sie sehen darf',
	'components.personSearch.shared': 'Geteilt',
	'components.personSearch.private': 'Privat',
