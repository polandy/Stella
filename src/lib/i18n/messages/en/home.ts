...
export const home = {
	...
	'home.filter.member': 'Who',
	'home.filter.kind.all': 'Everything',
	'home.filter.kind.moment': 'Moments',
	'home.filter.kind.interaction': 'Calls & visits',
	'home.filter.kind.relationship': 'Relationships',
	'home.filter.kind.person': 'New people',
	'home.filter.kind.notice': 'Notices',
	'home.filter.member.all': 'Everyone',
