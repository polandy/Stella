...
export const circles = {
	...
	'circles.selectMember': (p: { name: string }) => `Select ${p.name}`,
	'circles.selectRole': (p: { role: string }) => `Select all in ${p.role}`,
	'circles.selectAll': 'all',
	'circles.selectedCount': (p: { count: number }) => `${p.count} selected`,
	'circles.selectNone': 'Nobody selected',
	'circles.selectEveryone': 'Everyone',
	'circles.selectNoOne': 'No one',
	'circles.bulkRole': 'Set role',
	'circles.bulkRoleHint': 'Role (empty = none)',
	'circles.bulkApply': 'Apply',
